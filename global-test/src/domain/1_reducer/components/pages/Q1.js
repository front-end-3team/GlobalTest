...
import { ADD_INGREDIENTS, ingredientReducer, REMOVE_List } from '../../../../store/1_reducer';
...
const ReducerQ1Page = () => {
    ...
    */
    ...
    const onSubmit = (name, price) => {
        dispatch(ADD_INGREDIENTS({ name, price }));
    };
    ...
    return (
        <>
            ...
            <table>
                ...
                <ReducerQ1List ingredients={ingredients} onRemoveList={onRemoveList} />
            </table>
